    ...
    if (serial_str.includes("+IPD") && serial_str.includes("HTTP")) {
        ...
        switch (GET_command) {
            ...
            case "Happy": // request 192.168.x.x/Happy
                ...
                break
            case "Forward": // request 192.168.x.x/Forward
                GET_success = true
                LED_status = 1 - LED_status
                pins.digitalWritePin(LED_pin, LED_status)
                ...
                break
            case "Backward": // request 192.168.x.x/Backward
                GET_success = true
                LED_status = 1 - LED_status
                pins.digitalWritePin(LED_pin, LED_status)
                ...
                break
            case "Stop": // request 192.168.x.x/Stop
                GET_success = true
                LED_status = 1 - LED_status
                ...
                pins.digitalWritePin(LED_pin, LED_status)
                break
            case "TurnLeft": // request 192.168.x.x/TurnLeft
                GET_success = true
                LED_status = 1 - LED_status
                pins.digitalWritePin(LED_pin, LED_status)
                ...
                break
            case "TurnRight": // request 192.168.x.x/TurnLeft
                GET_success = true
                LED_status = 1 - LED_status
                pins.digitalWritePin(LED_pin, LED_status)
                ...
                break
            case "PlayMusic": // request 192.168.x.x/PlayMusic
                GET_success = true
                LED_status = 1 - LED_status
                pins.digitalWritePin(LED_pin, LED_status)
                ...
                break
            case "AutoPilot": // request 192.168.x.x/AutoPilot
                GET_success = true
                LED_status = 1 - LED_status
                pins.digitalWritePin(LED_pin, LED_status)
